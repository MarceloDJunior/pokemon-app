...
final Map<String, int> TYPES_COLORS = {
  ...
  TypeEnum.water.name: 0xFF00B0FF,
  TypeEnum.flying.name: 0xFFA791F0,
  TypeEnum.grass.name: 0xFF00C853,
  TypeEnum.poison.name: 0xFFAB47BC,
  TypeEnum.electric.name: 0xFFF8CF31,
  TypeEnum.ground.name: 0xFFE1BF6B,
  TypeEnum.psychic.name: 0xFFF85887,
  TypeEnum.rock.name: 0xFFB89F39,
  TypeEnum.ice.name: 0xFF80DEEA,
